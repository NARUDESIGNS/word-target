      ...
      <div>
          ...
          <div className="dim">
              ...
              <div className="modal">
                  ...
                  <h2>The Goal</h2>
                  <p>
                      The goal is to <b>spell a word</b> (using the tiles) with letters that fills all the blank boxes and also combines it score points to meet the target.
                      For example, if you have <b>4 blank boxes and target score of 9</b>, your goal is to spell a 4 letter word and the score points of the letters used must add up to give the target. <br />
